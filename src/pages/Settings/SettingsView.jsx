...
const SettingsView = () => {
  ...
  <div className="w-full min-h-full bg-[#F8FAFC] dark:bg-gray-900  text-[#1E293B] dark:text-gray-100">
    ...
    <header className="sticky top-0 z-30 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <div>
    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
      <div className="w-full space-y-4 sm:space-y-6 lg:space-y-8 pb-20">
        <ProfileSection/>
